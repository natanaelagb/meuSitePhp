	...
	<div class="menu">
		...
		<div class="box-links">
			...
			<a <?php atualMenu("cadastrar-usuario");
				permissaoVisualizarMenu($_SESSION['cargo']) ?> href="<?php echo INCLUDE_PATH_PAINEL; ?>cadastrar-usuario">Cadastrar Usuário</a>
			...
			<h2 <?php permissaoVisualizarMenu($_SESSION['cargo']) ?>>Gestão de Clientes</h2>
