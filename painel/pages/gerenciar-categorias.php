<?php
	...
	{
		Painel::ordenar($_GET['ordenar'],$_GET['id'],"tb_site.categorias");
	}
	...
	if(isset($_GET['excluir']))
	{
		...
		Painel::redirecionar(INCLUDE_PATH_PAINEL."gerenciar-categorias");
	}
	...
	$conteudo = Painel::selecionarTudo("*",'tb_site.categorias',($paginaAtual-1)*$quantidade,$quantidade,"order_id");

	$totalElementos = count(Painel::selecionarTudo("id","tb_site.categorias"));
...
<div class="content">
	<div class="box-content">
		...
		<h2><i class="far fa-comment-alt"></i> Categorias Cadastradas</h2>
		...
		<div class="box-tabela">
			...
			<?php foreach ($conteudo as $key => $value){?>
				...
				<tr>
					...
					<td style="width: 15%">
						<a id="deletar" actionBtn="deletar-categoria" href="<?php echo INCLUDE_PATH_PAINEL;?>gerenciar-categorias?excluir=<?php echo $value['id']?>"><i class="fas fa-trash-alt"></i> Excluir </a>
					</td>
